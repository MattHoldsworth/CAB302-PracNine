...
public class TransactionsTest {
	...
	final Integer positive = new Integer(3);
	...
	public void RunningOutOfCash() throws WarehouseException {
		...
		Integer daysOfProfitability = new Double(ceil((double)cash / eachDaysLoss)).intValue();
	...
	public void RestockingWhenAlreadyFull() throws WarehouseException {
		...
		assertEquals(typicalLedger.inStock(), new Integer(stock - positive)); // restocking had no effect
	...
	public void RunningOutOfCashByPayingForEmptyDeliveryTrucks() throws WarehouseException {
		Integer maxDeliveriesAffordable = new Double(ceil((double)cash / delivery)).intValue();
