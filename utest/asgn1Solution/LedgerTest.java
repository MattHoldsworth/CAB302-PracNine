...
public class LedgerTest {
	 ...
	 */
	final Integer negative = new Integer(-1);
	...
	public void SellingItemsCashIncreased() throws WarehouseException {
		final Integer sold = 2;
		assertTrue(typicalLedger.sellItems(sold)); // sell
		assertEquals(typicalLedger.cashAvailable(), new Integer(cash + (sold * retail))); // cash increased
	}
	...
	public void SellingItemsStockReduced() throws WarehouseException {
		final Integer sold = 2;
		assertTrue(typicalLedger.sellItems(sold)); // sell
		assertEquals(typicalLedger.inStock(), new Integer(stock - sold)); // stock reduced
	}
	...
	public void BuyingItemsCashReduced() throws WarehouseException {
		...
		assertEquals(typicalLedger.cashAvailable(),
				new Integer(cash - (bought * wholesale) - delivery)); // cash reduced
	}
	...
	public void BuyingItemsStockIncreased() throws WarehouseException {
		final Integer bought = 3;
		typicalLedger.buyItems(bought); // buy (and pay for delivery)
		assertEquals(typicalLedger.inStock(), new Integer(stock + bought)); // stock increased
	}
	...
	public void RunningOutOfStockCashIncreased() throws WarehouseException {
		...
		assertEquals(typicalLedger.cashAvailable(),
				new Integer(cash + (stock * retail))); // cash increased
	}	
	...
	public void GoingIntoDebtCashNegative() throws WarehouseException {
		...
		assertEquals(typicalLedger.cashAvailable(),
				new Integer(cash - ((bought * wholesale) + delivery))); // cash is negative
	}
	...
	public void PreviousDaysCashRemembered() throws WarehouseException {
		PerformTransactions();
		// End of day 1
		assertEquals(typicalLedger.cashAvailable(1), new Integer(95));
		// End of day 2
		assertEquals(typicalLedger.cashAvailable(2), new Integer(-65));
	}
	...
	public void PreviousDaysStockRemembered() throws WarehouseException {
		PerformTransactions();
		// End of day 1
		assertEquals(typicalLedger.inStock(1), new Integer(9));
		// End of day 2
		assertEquals(typicalLedger.inStock(2), new Integer(13));
	}
	
	@Test
	public void TransactionsCarryAcrossDays() throws WarehouseException {
		PerformTransactions();
		assertEquals(typicalLedger.currentDay(), new Integer(3));
		assertEquals(typicalLedger.cashAvailable(), new Integer(110));
		assertEquals(typicalLedger.inStock(), new Integer(6));
	}
	...
	public void BuyingZeroItems() throws WarehouseException {
		...
		assertEquals(typicalLedger.currentDay(), one); // day unchanged
		assertEquals(typicalLedger.cashAvailable(),
				new Integer(cash - delivery)); // cash reduced
		assertEquals(typicalLedger.inStock(), stock); // stock unchanged
	}
	...
	public void SellingEntireStock() throws WarehouseException {
		...
		assertEquals(typicalLedger.cashAvailable(),
				new Integer(cashReserve + (retail * onShelves))); // cash increased
